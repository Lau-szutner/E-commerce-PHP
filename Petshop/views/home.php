            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 mb-4">
                    <div class="card text-center p-3 h-100 d-flex flex-column">
                        <h3>Veterinaria</h3>
                        <img src="img/vete.jpg" alt="Foto de veterinaria" class="img-fluid mb-3 rounded-2">
                ...
                <div class="col-lg-4 mb-4">
                    <div class="card text-center p-3 h-100 d-flex flex-column">
                        <h3>Guardería</h3>
                        <img src="img/guarderia.jpg" alt="Foto de guardería" class="img-fluid mb-3 rounded-2">
                ...
                <div class="col-lg-4 mb-4">
                    <div class="card text-center p-3 h-100 d-flex flex-column">
                        ...
                        <img src="img/peluqueria.webp" alt="Foto de estilista canino" class="img-fluid mb-3 rounded-2">
