<section class="container mb-5 pt-5">
    <div class="row"></div>
    <h2 class="text-center pt-5">Bienvenido al Panel de Administración de Paw Petshop</h2>
    <h3 class="text-center">Gestiona tu tienda de mascotas de manera eficiente y rápida.</h3>
