<section id="" class="container d-flex flex-column p-5">
  ...
  <article class="row d-flex">
    ...
    <div class="col">
      ...
      <p>En Paw Petshop, nuestra prioridad es asegurarnos de que tú y tus mascotas tengan la mejor experiencia posible. Sin embargo, parece que algo salió mal y no pudimos encontrar la página que buscabas.</p>
    </div>
  </article>
  <article class="d-flex flex-column align-items-center pt-5">
    <p><strong> Aquí tienes algunas opciones para seguir navegando: </strong> </p>
