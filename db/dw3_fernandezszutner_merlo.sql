...
-- Tiempo de generación: 12-07-2024 a las 15:55:34
...
(1, 'pedromartin@gmail.com', '$2b$12$o9TtbWqqWVt6LJ1urlGxG.UbldvzpUmc1QOuc.rE7BtDxEdC0jwJ2', 'admin'),
(2, 'clarita.gomez@gmail.com', 'fernando234', 'usuario'),
(3, 'kevinrogers@hotmail.com', 'arbustO31', 'admin'),
(4, 'laura.salas@gmail.com', '4567dhd', 'usuario');
...
ALTER TABLE `usuario`
  ...
  ADD KEY `rol_fk` (`rol`) USING BTREE;
...
--
ALTER TABLE `producto`
  MODIFY `producto_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;
